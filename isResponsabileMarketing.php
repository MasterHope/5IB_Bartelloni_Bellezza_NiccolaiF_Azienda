<?php
//Questo file viene utilizzato per verificare se una determinata persona è un responsabile del marketing o meno.
...
<html>
    ...
    <body>
        ...
        <div class="alert-danger"><h6 style="text-align: center;font-family: inherit">
                L'utente loggato non è un responsabile del marketing! Impossibile accedere a quest'area!</h6></div>
        </div>
            <?php die;} ?>
        </div>
    </body>
